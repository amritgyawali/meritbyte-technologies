...
// Saves the popup's business name and email to public.subscribers. Posting an
// address that is already there updates its business name and subscribes it
// again, with the new consent record.
export async function POST(request) {
  ...
  try {
    await supabase("subscribers?on_conflict=email", {
      method: "POST",
